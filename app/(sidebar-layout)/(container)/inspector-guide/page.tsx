...
export default function InspectorGuidePage() {
  ...
  const sseEndpoint = `https://noc-metatool-app.srv817320.hstgr.cloud/sse with Authorization: Bearer ${apiKey?.api_key || '<YOUR_API_KEY>'}`;
  const urlBasedSseEndpoint = `https://noc-metatool-app.srv817320.hstgr.cloud/api-key/${apiKey?.api_key || '<YOUR_API_KEY>'}/sse`;
