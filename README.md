...
```
https://noc-metatool-proxy.srv817320.hstgr.cloud/sse with Authorization: Bearer <your-api-key>
```

Alternatively, if you cannot set headers, you can use this URL-based endpoint:

```
https://noc-metatool-proxy.srv817320.hstgr.cloud/api-key/<your-api-key>/sse
```
